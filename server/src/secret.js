...
export { defaultImage, mongoDbLoacalUrl, mongoDbAtlasUrl, serverPort, jwtSecretKey, fileSize, allowedFile, defaultEmployeeImagePath, defaultUserImagePath, tokenDuration };
